...
namespace Basement {
	...
	public:
		...
		static void SubmitArraysForPoints(SharedPtr<Shader> shader, SharedPtr<VertexArray> vertexArray, u32 first, u32 count, const glm::mat4& modelMatrix);
		static void SubmitArraysForLines(SharedPtr<Shader> shader, SharedPtr<VertexArray> vertexArray, u32 first, u32 count, const glm::mat4& modelMatrix);
